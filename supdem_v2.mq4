...
extern bool HUD_on = true;
extern int layer_zone = 0;
extern int layer_HUD = 20;
extern int corner_HUD = 3;
extern int pos_x = 100;
extern int pos_y = 10;
extern bool alert_on = true;
extern bool alert_popup = true;
extern string alert_sound = "alert_wav";
extern color color_sup_strong = Green;
extern color color_sup_weak = Yellow;
extern color color_sup_retouch = DarkGreen;
extern color color_dem_strong = Crimson;
extern color color_dem_weak = HotPink;
extern color color_dem_retouch = MediumVioletRed;
...
extern color color_timer_back = DarkGray;
...
//         if(c == color_sup_weak && !no.weak_zones) draw = false;
         if(draw){
...
string TimeFrameToString(int tf1) //code by TRO
{
   string tfs;
   switch(tf1) {
